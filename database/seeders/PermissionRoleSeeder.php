...
class PermissionRoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin_permissions = $master_admin_permissions->filter(function ($permission) {
            return $permission->title != 'student_access' && $permission->title != 'user_management_access' && substr($permission->title, 0, 5) != 'role_' && substr($permission->title, 0, 11) != 'permission_';
        });
